...
Where HCI focuses on the interfaces between humans and technology, data visualization is about the analog interface between humans and data. Good data visualization relies on the same principles for good product design, namely: coherency, simplicity, ease of human interpretation, and minimal cognitive leakage.
